import { Target, Eye, Heart, Users, Award, Globe, Clock, ShieldCheck } from "lucide-react";
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <ScrollAnimator>
              <div className="p-10 md:p-14 rounded-2xl bg-navy-gradient relative overflow-hidden">
                <div className="absolute top-0 right-0 w-64 h-64 bg-gold/5 rounded-full -translate-y-1/2 translate-x-1/2" />
                <div className="relative z-10">
                  <span className="text-gold font-semibold text-sm uppercase tracking-widest">Message from Leadership</span>
                  <h2 className="text-2xl md:text-3xl font-display font-bold text-white mt-4 mb-6">A Word From Our CEO</h2>
                  <blockquote className="text-white/80 text-lg leading-relaxed italic border-l-4 border-gold pl-6">
                  ...
                  <div className="mt-8 flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-white font-display font-bold">Leadership Team</p>
                      <p className="text-white/50 text-sm">Urban Stallion Consultancy</p>
                    </div>
                  </div>
                </div>
              </div>
